...
"""
Simply opening our data file and storing it in data_file object
Then, with the help of that object, we are converting json strings into python dictionary
...
"""
Iterating the complete python dictionary, and then tokenizeing it
Tokenize - Splitting in words 
"""
...
"""
We are creating and storing all our words in text.pkl and
classes in label.pkl
Using dump - to store python objects in file
"""
...
# Create model -  second layer 64 neurons and 3rd output layer contains number of neurons
